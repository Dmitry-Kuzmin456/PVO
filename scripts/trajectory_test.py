...
def run_test():
    # replicate the default scenario from app/main.py
    start_ws = 0.0
    start_wd = 0.0
    ...
    print(f'find_perfect_trajectory finished in {dt_search:.2f}s')

    # simulate with high-fidelity dt
    sim_dt = 0.005
    sim_time = 0.0
    max_time = 30.0
    ...
    if min_state:
        ...
        print(f'at t={stime:.3f}s missile={mpos} target={tpos} diff={tpos-mpos}')
